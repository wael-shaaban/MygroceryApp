...
namespace grocercy.Api.Data.Migrations
{
    ...
    [Migration("20240730124646_firstmigration2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.Address", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.Category", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.Address", b =>
                {
                    b.HasOne("GerogercyApp.Api.Data.Entities.User", "User")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.OrderItem", b =>
                {
                    b.HasOne("GerogercyApp.Api.Data.Entities.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GerogercyApp.Api.Data.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.Product", b =>
                {
                    b.HasOne("GerogercyApp.Api.Data.Entities.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("GerogercyApp.Api.Data.Entities.User", b =>
                {
                    b.HasOne("GerogercyApp.Api.Data.Entities.Role", "Role")
                        .WithMany()
