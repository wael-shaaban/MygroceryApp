        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "50OFF", "#ea978d", "Enjoy our big offer of 50% off on all green vegetables", false, "Green Veg Big Sale 50% OFF" },
                    { 3, "EXT100", "#ea978d", "Flat Rs. 100 off on all exotic fruits and vegetables", false, "Flat 100 OFF" },
                    { 4, "FRT25", "#dad1f9", "Enjoy 25% off on all seasonal fruits", false, "25% OFF on Seasonal Fruits" }
                });
